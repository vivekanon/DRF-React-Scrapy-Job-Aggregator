      ...
      <div className="flex lg:flex-row flex-col justify-between w-4/5 mx-auto p-2 ">
        <div className="flex lg:w-1/4 w-full  flex-wrap">
          ...
          <div className="flex mt-6">
            <p className="font-semibold text-blue-800 text-xs leading-loose">
          ...
          <div className="flex mt-10">
            <p className="font-semibold text-blue-800 text-sm leading-loose">
              Let's Talk:{" "}
        ...
        <div className="flex flex-col lg:w-1/4 w-full lg:mt-0 mt-10">
          <div className="flex">
            <h2 className="text-blue-800 text-base uppercase ">
              Submit for updates
            </h2>
          </div>
          <div className="flex flex-col flex-1 justify-around mt-6">
            ...
            <form className="justify-around rounded mt-4 mb-4">
              <input
                className="bg-white border-2 rounded text-base appearance-none w-full py-4 px-3 text-blue-800 focus:outline-none focus:shadow-outline"
                type="text"
